 ...
 ***************************************************************************/
////////////////////////////////////////////////////////////////////////////
//int mst_pack (MSTrace *mst, void (*record_handler) (char *, int, void *),
...
int
mst_pack (MSTrace *mst, int reclen, flag encoding, flag byteorder,
          int64_t *packedsamples, flag flush, flag verbose,
          MSRecord *mstemplate, char **record)
{

	char *record_temp;
	*record = (char *)malloc(512);
