...
void Protocentral_ADS1220::begin()
{
  ...
  SPI.transfer(0x00);   
  */
  Config_Reg0 = 0x21; //0x21 AIN0-AIN3, 0x91 AIN1 - AVSS,  0x21 AINP=AIN0 AINN=AIN3  1 gain  pga disabled, 0x25 gain 4, 0x23 gain of 2, 0x01 AINP = AIN0 AINN = AIN1, 0x81 AINP =  AIN0, AINN = AVSS, 0xB1 AINP = AIN3 AINN = AVSS
  Config_Reg1 = 0xA4; // 0x84 330 SPS/200, A4 600 SPS, 0x04 20 SPS, 0x24 45 SPS, 0x44 90 SPS, 0x64 175 SPS/100, 0x84 330 SPS, 0xC4 1000 SPS, 0XB4 TURBO MODE @ 1200 SPS, 0xD4 tubo mode @ 2000
...
void Protocentral_ADS1220::powerDown()
{
