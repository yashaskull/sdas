...
void Protocentral_ADS1220::begin()
{
  ...
  SPI.transfer(0x00);   
  */
  Config_Reg0 = 0xB0; // 0x21 AINP=AIN0 AINN=AIN3  1 gain  pga disabled, 0x25 gain 4, 0x23 gain of 2, 0x01 AINP = AIN0 AINN = AIN1, 0x81 AINP =  AIN0, AINN = AVSS, 0xB1 AINP = AIN3 AINN = AVSS
