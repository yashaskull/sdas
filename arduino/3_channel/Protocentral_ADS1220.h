...
//#define REG_CONFIG_DR_100SPS 0x60
...
//#define PGA_ON (Config_Rneweg0 & ~_BV(0))
//#define PGA_OFF (Config_Reg0 | _BV(0))

/**
#define ADS1220_CS_PIN_1 41
#define ADS1220_CS_PIN_2 45
#define ADS1220_CS_PIN_3 49

#define ADS1220_DRDY_PIN_1 39
#define ADS1220_DRDY_PIN_2 43
#define ADS1220_DRDY_PIN_3 47
*/
...
#define ADS1220_DRDY_PIN_1 46
#define ADS1220_DRDY_PIN_2 42
#define ADS1220_DRDY_PIN_3 38
...
class Protocentral_ADS1220
{
  private:
    ...
    uint8_t Config_Reg1;
    uint8_t Config_Reg2;
    uint8_t Config_Reg2_Z;
    uint8_t Config_Reg3;

  public:
    uint8_t NewDataAvailable_1;
    uint8_t NewDataAvailable_2;
    uint8_t NewDataAvailable_3;
    ...
    uint8_t * Read_Data_1(void);
    uint8_t * Read_Data_2(void);
    uint8_t * Read_Data_3(void);
    uint8_t * Read_Data_test();
